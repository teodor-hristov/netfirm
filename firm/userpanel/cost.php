                ...
                <section class="content">
                                  ...
                                  <li  class="list-group-item">                                        
                                    ...
                                    <li  class="list-group-item">                                        
                                        <div class="panel-body">
                                                ...
                                                form.reset(); " class="btn btn-danger"><i class="fa fa-plus"></i> Добави разход</button>  
                                                <?php
                                    if(isset($_POST['addI']))
                                    {
                                    $email = $_SESSION['user']['email'];
                                    ...
                                    {
                                        echo "<h3 style='text-align:center;' class='alert alert-warning'>Моля въведете информацията в полетата: Разход и Стойност</h3>";
                                    }
                                    else
                                    {
                                        mysql_query("INSERT INTO `cost` (`email`, `money`, `description`, `month`, `time`) VALUES('$email', '-$value', '$desc', '$month', '$date')");
                                        echo "<h3 style='text-align:center;' class='alert alert-success'>Разходът е добавен успешно!</h3>";
                                    }
                                    }
                                    else
                                    {
                    ...
                    <div class="row">
                                ...
                                <ul style="width: 162%" id="lit" class="list-group teammates">
                                        ...
                                        <?php
                    $email = $_SESSION['user']['email'];
                    $last = mysql_query("SELECT * FROM `cost` WHERE `email` = '$email' ORDER BY `id` DESC LIMIT 5");
                    $number = 1;
                    ...
                    {   
                       ...
                       <b><?php echo $newnumber;?> | </b><b>Стойност:</b><font color="red"><?php echo $lastprofit?> </font>лева | <b>Разход:</b><?php echo $lastprofitdesc;?><a href="" style="color: red; float: right;" id="<?php echo $id;?>" class="fa fa-trash-o delete"></a></div>
                                        </li>
                       <?php
                    }
                ...
                var data = {
                    ...
                    datasets: [
                        
                        {
                            ...
                            fillColor: "rgba(232, 0, 17, 0.2)",
                            strokeColor: "rgba(232, 0, 17, 1)",
                            pointColor: "rgba(232, 0, 17, 1)",
